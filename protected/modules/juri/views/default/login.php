...
<div class="content">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<h3 class="form-title">Sign In Juri</h3>

		<div class="form-group">
			<?php echo $form->labelEx($model,'email',array('class'=>'control-label visible-ie8 visible-ie9')); ?>
			<?php echo $form->dropDownList($model,'email',UserJuri::optionsAll(),array('class'=>'select2me form-control input-lg form-control-solid placeholder-no-fix','placeholder'=>'Username','prompt'=>'-- PILIH NAMA BAPAK/IBU --')); ?>
