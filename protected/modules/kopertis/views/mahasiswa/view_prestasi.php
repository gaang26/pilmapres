...
$this->breadcrumbs = array(
    'Peserta'=>array('mahasiswa/view','id'=>$model->ID_PESERTA,'#'=>'prestasi'),
    $this->pageTitle
);
?>
<div class="row-fluid">
    <div class="span8 offset2">
        <div class="well bordered-dashed-1 text-center">
            <?php echo CHtml::link('<i class="icon-arrow-left"></i> Kembali',array('mahasiswa/view','id'=>$model->ID_PESERTA,'#'=>'prestasi'),array(
                'class'=>'btn'
            )); ?>
        </div>
