...
<link href="<?php echo $baseUrl;?>/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo $baseUrl;?>/assets/admin/layout3/css/layout.css" rel="stylesheet" type="text/css">
<link href="<?php echo $baseUrl;?>/assets/admin/layout3/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color">
<link href="<?php echo $baseUrl;?>/assets/admin/layout3/css/custom.css" rel="stylesheet" type="text/css">
<!-- END THEME STYLES -->
		...
		<div class="details">
			...
			<form action="javascript:;">
				<div class="input-group input-medium">
					<span class="">
						<?php echo CHtml::link('<i class="fa fa-arrow-left"></i> KEMBALI','javascript:history.go(-1)',array('class'=>'btn yellow')); ?>
						<?php echo CHtml::link('<i class="fa fa-home"></i> BERANDA',array('default/index'),array('class'=>'btn btn-primary')); ?>
					</span>
				</div>
				<!-- /input-group -->
			</form>
...
<script src="<?php echo $baseUrl;?>/assets/admin/layout3/scripts/layout.js" type="text/javascript"></script>
<script src="<?php echo $baseUrl;?>/assets/admin/layout3/scripts/demo.js" type="text/javascript"></script>
<script>
