...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="form-group row">
        <?php echo $form->labelEx($model,'ID_KOPERTIS',array('class'=>'col-md-2')); ?>
        <div class="col-md-10">
            <?php echo $form->dropDownList($model,'ID_KOPERTIS',MasterKopertis::optionsAll(),array('prompt'=>'--Pilih kopertis--','class'=>'form-control select2me')); ?>
    ...
    <div class="form-group row">
        <?php echo $form->labelEx($model,'TELP',array('class'=>'col-md-2')); ?>
        <div class="col-md-10">
            <?php echo $form->textField($model,'TELP',array('class'=>'form-control')); ?>
