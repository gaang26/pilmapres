<?php
$this->pageTitle = 'Manajemen User Juri';
...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <?php echo CHtml::link('<i class="fa fa-plus"></i> Tambah User',array('user/create','type'=>WebUser::ROLE_JURI),array(
    ...
    <div class="portlet-body">
		...
		<?php $this->renderPartial('juri/_search',array(
			'model'=>$user,
		)); ?>
		</div><!-- search-form -->
